# Course Projects & Python Implementations

Curated coursework and practical implementations of Python fundamentals, including Object-Oriented Programming (OOP), Functional Programming (FP), data structures, and algorithms.
...
*   **[Virtual Pet](./OOP/Virtual%20Pet)**: Demonstrates time/turn-based state management for pet needs.
*   **[RPG Combat Simulator](./OOP/rpg-combat-simulator)**: A multi-file combat engine that implements strict encapsulation, inheritance, and polymorphism.

### Functional Programming (`/FP`)
*   **[Book Library Manager](./FP/Comprehensions/Book%20Library%20Manager/)**: Advanced list, dictionary, and set comprehension implementations for the Book Library Manager.
