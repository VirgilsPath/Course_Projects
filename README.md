...
*   **[RPG Combat Simulator](./OOP/rpg-combat-simulator)**: (Latest) A multi-file combat engine that implements strict encapsulation, inheritance, and polymorphism.

### Functional Programming (`/FP`)
*   **[Comprehensions](./FP/Comprehensions)**: Advanced list, dictionary, and set comprehension implementations for the Book Library Manager.
